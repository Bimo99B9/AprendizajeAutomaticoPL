...
print("###################################################################")
print("1. Carga el conjunto de datos  **gastroenterology.data**")
print("###################################################################")
...
print("###################################################################")
print("2. Sepáralo en 80% para entrenar y 20% para test.")
print("###################################################################")
...
print("###################################################################")
print("3. Prueba los algoritmos PCA y LinearDiscriminantAnalysis")
print("###################################################################")
...
if num_componentes == 2:
    ...
    plt.savefig(
        "S26 - Reducción de dimensionalidad Feature extraction\src_pca_"
        + str(num_componentes)
        + "D.png"
    )
...
if num_componentes == 2:
    ...
    plt.savefig(
        "S26 - Reducción de dimensionalidad Feature extraction\src_lda_"
        + str(num_componentes)
        + "D.png"
    )
